      ...
      <section className="bg-primary pt-28 pb-16 sm:pt-36 sm:pb-20 relative overflow-hidden">
        ...
        <div className="container-xl relative z-10">
          ...
          <p className="text-slate-300 font-outfit text-lg max-w-xl leading-relaxed">
            From full system installations to targeted repairs, every job gets the same
      ...
      <section className="section-padding bg-bg-light" aria-labelledby="gallery-heading">
        <div className="container-xl">
          <div className="text-center mb-10">
            ...
            {/* Category pills */}
            <div className="flex flex-wrap justify-center gap-2" role="list" aria-label="Filter categories">
              {CATEGORIES.map((cat) => (
                <span
                  key={cat}
                  role="listitem"
            ...
            {GALLERY_ITEMS.map(({ id, src, alt, caption, category }) => (
              ...
              >
                <div className="relative h-56 sm:h-64 overflow-hidden bg-slate-100">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true" />
                </div>
                <div className="p-4 flex items-center justify-between">
                  <div>
                    <h3 className="font-outfit font-semibold text-primary text-sm">
                      {caption}
                    </h3>
                  </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-xl text-center">
          <h2 className="section-title text-3xl sm:text-4xl mb-4">
            Need HVAC Work Done Right?
          </h2>
          <p className="text-slate-500 font-outfit text-base mb-8 max-w-lg mx-auto">
            Call Eric or request a service online. Every job gets the same quality
            you see above.
          </p>
