      ...
      <section className="bg-primary pt-28 pb-16 sm:pt-36 sm:pb-20 relative overflow-hidden">
        ...
        <div className="container-xl relative z-10">
          ...
          <p className="text-slate-300 font-outfit text-lg max-w-2xl leading-relaxed">
            Aviles Heating &amp; Air Conditioning was built from the ground up on honest
            service, expert workmanship, and a genuine commitment to Northern Virginia
            homeowners.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 font-outfit text-base leading-relaxed">
                <p>
                  Eric Aviles is a licensed, insured HVAC technician with over a decade
                  of hands-on experience serving homeowners in Herndon and across Northern
                  Virginia. He founded Aviles Heating &amp; Air Conditioning with one goal:
                  to provide the kind of honest, expert service that he&apos;d want for his
                  own family.
                </p>
                <p>
                  Unlike large HVAC companies where you never know who&apos;s showing up,
                  when you call Aviles, you get Eric. He diagnoses your system accurately,
                  explains what&apos;s wrong in plain language, and gives you a fair quote
                  before any work begins.
                </p>
                <p>
                  His customers consistently praise not just his technical skill, but his
                  character—the fact that he&apos;ll pick up the phone and walk you through
                  a problem even when he&apos;s off the clock. That level of dedication is
                  what built a 4.9-star reputation entirely on word of mouth.
                </p>
                <p>
                  Whether it&apos;s a routine tune-up or a midnight emergency, Eric shows
                  up prepared, works efficiently, and leaves your home clean. That&apos;s
                  the Aviles promise.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-primary rounded-xl p-8">
                <div className="flex gap-0.5 mb-4">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <svg key={s} width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24" aria-hidden="true">
              ...
              <div className="bg-secondary rounded-xl p-8">
                ...
                <blockquote className="text-white text-lg font-outfit italic leading-relaxed mb-4">
                  &ldquo;His price was fair and his work and product knowledge was
                  excellent.&rdquo;
                </blockquote>
      ...
      <section className="section-padding bg-white">
        <div className="container-xl">
          <div className="max-w-2xl mx-auto">
            ...
            <ol className="relative border-l-2 border-slate-200 space-y-8 pl-8" aria-label="Company milestones">
      ...
      <section className="section-padding bg-bg-light">
        <div className="container-xl text-center">
          <h2 className="section-title text-3xl sm:text-4xl mb-4">
            Ready to Work with Eric?
          </h2>
          <p className="text-slate-500 font-outfit text-base mb-8 max-w-lg mx-auto">
            Whether you need an emergency repair or want to schedule a maintenance visit,
...
function ShieldIcon() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><polyline points="9 12 11 14 15 10" /></svg>;
}
function StarIcon() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>;
}
function ClockIcon() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>;
}
function WrenchIcon() {
...
function PhoneIcon() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.8a16 16 0 0 0 6.29 6.29l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg>;
}
