      ...
      <section className="bg-primary pt-28 pb-16 sm:pt-36 sm:pb-20 relative overflow-hidden">
        ...
        <div className="container-xl relative z-10">
          ...
          <p className="text-slate-300 font-outfit text-lg max-w-2xl leading-relaxed mb-8">
            From emergency AC repair to full system installations, we handle every aspect of
            residential HVAC in Herndon, Reston, Sterling, and all of Northern Virginia.
          </p>
        ...
        <div className="container-xl">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 font-outfit text-base max-w-xl mx-auto mt-3">
              From your first call to a fully working system — here&apos;s what to expect when you
              work with Aviles Heating &amp; Air Conditioning.
            </p>
          </div>
          ...
          <div className="bg-primary rounded-2xl p-8 sm:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h2
                ...
                className="font-outfit font-bold text-white text-3xl sm:text-4xl mb-4"
              >
